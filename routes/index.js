...
(function() {
  var Evernote, Note, Sync, Sync2, SyncStatus, Tags, async, client, crypto, express, fs, getLocalTime, getYear, help, noteStore, router, toInt, uniq;
  ...
  router.get('/img', function(req, res) {
    var data, hash, hashHex, image, md5, note, resource, statInfo;
    ...
    return noteStore.createNote(note, function(err, info) {
      if (err) {
        return console.log(err);
      }
