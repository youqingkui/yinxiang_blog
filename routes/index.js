...
(function() {
  var Evernote, Note, Sync, SyncStatus, Tags, async, client, express, getLocalTime, getYear, help, hexdump, noteStore, router, toInt, uniq;
  ...
  router.get('/res', function(req, res) {
    return noteStore.getNote('c47386e3-b9c3-4964-8dfe-c77f8b2af594', false, false, false, false, function(err, info) {
      if (err) {
        return console.log(err);
      }
  ...
  router.get('/res2', function(req, res) {
    return noteStore.getResource('c41e5d85-a39c-4d72-ad40-345da51f4a15', true, false, false, false, function(err, info) {
      if (err) {
        return console.log(err);
      }
      return res.send(info);
  ...
  router.get('/hash', function(req, res) {
    ...
    console.log(hash);
    return noteStore.getResourceByHash('2d7cd66f-110f-40a2-9d59-e20b13e072a7', hash.encode_utf8(), true, false, false, function(err, data) {
      if (err) {
        return console.log(err);
      }
