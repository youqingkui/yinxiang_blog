...
(function() {
  var Evernote, Note, SyncNewNote, SyncStatus, async, client, noteStore;
  ...
  SyncNewNote.prototype.checkSimpleNote = function(simpleArr, cb) {
    ...
    return async.eachSeries(simpleArr, function(item, callback) {
      return Note.findOne({
        ...
        if (!note) {
          self.createNote(item, function(cErr, newNote) {
